...
def generate_additional(edge,G,interval,intervals,suffix):
    ...
    lines = ('<additional>\n'
                            ...
                            '<edgeData id="5" file="../output/edgeData'+ suffix +'.xml" begin="'+ str(intervals[0][0]) + '" end="'+ str(intervals[0][1]) + '" type="emissions"/>\n'
                            '<edgeData id="6" file="../output/edgeData'+ suffix +'.xml" begin="'+ str(intervals[1][0]) + '" end="'+ str(intervals[1][1]) + '" type="emissions"/>\n'
                            '<edgeData id="7" file="../output/edgeData'+ suffix +'.xml" begin="'+ str(intervals[2][0]) + '" end="'+ str(intervals[2][1]) + '" type="emissions"/>\n'
                            '<edgeData id="8" file="../output/edgeData'+ suffix +'.xml" begin="'+ str(intervals[2][1]) + '" end="10000" type="emissions"/>\n'
